                            ...
                            <div class="product" style="cursor:pointer;border-radius:18px;box-shadow:0 2px 16px #e3e3e3;transition:box-shadow .2s,transform .2s;background:#fff;overflow:hidden;position:relative;min-height:420px;display:flex;flex-direction:column;justify-content:space-between;height:100%;">
                                ...
                                <div class="product-body" style="padding:18px 24px 0 24px;">
                                    ...
                                    <h4 class="product-price" style="font-size:1.2rem;color:#d10024;font-weight:800;margin-bottom:6px;">
                                        {{ number_format($newPrice) }} VNĐ @if($product->old_price) <del class="product-old-price" style="color:#aaa;font-size:1rem;font-weight:400;">{{ number_format($product->price) }} VNĐ</del>@endif
                                    </h4>
                    ...
                    <div>
                        ...
                        <div class="product-widget" style="position:relative">
                            ...
                            <div class="product-body">
                                ...
                                <h4 class="product-price">{{ number_format($newPrice) }} VNĐ <del class="product-old-price">{{ number_format($product->price) }} VNĐ</del></h4>
                            </div>
                        </div>
                        @endforeach
                    </div>
            ...
            <div class="col-md-4 col-xs-6">
                ...
                <div class="products-widget-slick" data-nav="#slick-nav-5">
                    ...
                    <div>
                        ...
                        $newPrice = $product->price - $discountAmount;
                        @endphp
                        <div class="product-widget" style="position
                        <div class="product-widget" style="position:relative">
                            <a href="{{ route('products.show', $product->slug) }}" class="stretched-link" style="position:absolute;top:0;left:0;right:0;bottom:0;z-index:2;"></a>
                            <div class="product-img">
                                <img src="{{ asset('storage/' . $product->image_path) }}" alt="{{ $product->name }}">
