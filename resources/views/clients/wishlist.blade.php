...
<div class="col-lg-3 col-md-4 col-10 mb-4 wishlist-item"
    ...
    <div class="product"
        ...
        {{-- Thay bằng thẻ <a> để chuyển trang --}}
        <a href="{{ route('products.show', $product->slug) }}"
           class="wishlist-product-link-area"
           style="display:block;cursor:pointer;text-decoration:none;color:inherit;">
            <div class="product-img"
                 style="padding:28px 28px 0;text-align:center;background:#f8fafc;min-height:180px;display:flex;align-items:center;justify-content:center;">
            ...
            <div class="product-body" style="padding:20px 28px 0;">
